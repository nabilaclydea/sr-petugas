...
class ReferralCreatePatientDataScreen extends Component {
  ...
  _insuranceType() {
    HealthcareAPI.get("/patient/type/list").then((response) => {
  ...
  _identityType() {
    HealthcareAPI.get("/patient/identity/type/list").then((response) => {
      let list = response.data;
      let tmp = this.state.referralForm;
  ...
  _gender() {
    HealthcareAPI.get("/gender/list").then((response) => {
      let list = response.data;
      let tmp = this.state.referralForm;
  ...
  _religion() {
    HealthcareAPI.get("/religion/list").then((response) => {
      let list = response.data;
      let tmp = this.state.referralForm;
  ...
  _education() {
    HealthcareAPI.get("/education/list").then((response) => {
      let list = response.data;
      let tmp = this.state.referralForm;
  ...
  _marriage() {
    HealthcareAPI.get("/marriage/list").then((response) => {
      let list = response.data;
      let tmp = this.state.referralForm;
  ...
  _province() {
    HealthcareAPI.get("/province/list").then((response) => {
      let list = response.data;
      let tmp = this.state.referralForm;
  ...
  _city() {
    HealthcareAPI.get("/city/list").then((response) => {
      let list = response.data;
      let tmp = this.state.referralForm;
  ...
  _searchPatient() {
    ...
    if (this.state.identityNumberChanged.length > 0) {
      this.setState({
        ...
        identityNumber: this.state.identityNumberChanged,
        isPatientNotFoundSelected: false,
      });

      HealthcareAPI.get("/patient", {
        params: {
              ...
              {this.state.isFound ? (
                ...
                <View style={{ justifyContent: "center", height: 80 }}>
                  <Text style={{ color: "#000000", fontSize: 10 }}>
                    Maaf, nomor identitas yang anda isi tidak ditemukan
                  </Text>
                </View>
              )}
              {this.state.isFound ? (
                <View style={{ marginLeft: 20 }}>
                  ...
                  >
                    {this.state.referralForm.pasien.nama}
                  </Text>
                  <Text
                    style={{ color: "#cacaca", fontSize: 10, marginTop: 10 }}
                  >
                    {this.state.referralForm.pasien.noIdentitas}
                  </Text>
                </View>
              ) : null}
              <TouchableOpacity
                onPress={() => {
                  ...
                  if (this.state.isFound) {
                    ...
                    this.setState({
                      isPatientNotFoundSelected: true,
                      isSearched: false,
                    });
                  }
                }}
      ...
      return (
        <View>
            ...
            <View style={{ margin: 5 + "%" }}>
              {!this.state.isPatientFound && (
                <View style={{ alignItems: "center" }}>
                  <Text style={{ color: "#f05d5e", textAlign: "center" }}>
                    Pasien tidak ditemukan dalam sistem, silakan isi data pasien
                    secara manual.
                  </Text>
                </View>
              )}
              <View style={{ marginTop: 15 }}>
                ...
                <TextInput
                  ...
                  style={{
                    marginLeft: 4,
                    borderBottomColor: this._isError("nama")
                      ? "#c4c4c4"
                      : "#f05d5e",
                    borderBottomWidth: 1,
                  }}
              ...
              <View style={{ marginTop: 15 }}>
                ...
                >
                  <Picker
                    selectedValue={
                      this.state.referralForm.pasien.idJenisKelamin
                    }
                  ...
                  >
                    {this.state.gender.map((type) => (
                      <Picker.Item
                        label={type.namaJenisKelamin}
                        value={type.idJenisKelamin}
                        key={type.idJenisKelamin}
                      />
                    ))}
                  </Picker>
                </View>
              ...
              <View style={{ marginTop: 15 }}>
                  ...
                  <TouchableOpacity onPress={this._showDateTimePicker}>
                    <TextInput
                      value={
                        ...
                        " / " +
                        (this.state.birthDate.getMonth() + 1) +
                        " / " +
                ...
                <DateTimePicker
                  ...
                  onConfirm={(date) => {
                    ...
                    tmp2.pasien.tanggalLahir =
                      tmp.getFullYear() +
                      "-" +
                      this._doubleDigit(tmp.getMonth() + 1) +
                      "-" +
                      this._doubleDigit(tmp.getDate());
                    this._hideDateTimePicker;
                    this.setState({
                      isDateTimePickerVisible: false,
                      birthDate: tmp,
              ...
              <View style={{ marginTop: 15 }}>
                ...
                <TextInput
                  value={this._age(this.state.birthDate)}
                  editable={false}
                  selectTextOnFocus={false}
                  style={{ color: "#000000", marginLeft: 5 }}
                />
            ...
            <View style={{ margin: 5 + "%" }}>
              <View>
                ...
                <TextInput
                  ...
                  style={{
                    marginLeft: 4,
                    borderBottomColor: this._isError("noHandphone")
                      ? "#c4c4c4"
                      : "#f05d5e",
                    borderBottomWidth: 1,
                  }}
                ...
                {!this._isError("noHandphone") && (
                  <Text
                    style={{ color: "#f05d5e", fontSize: 12, marginLeft: 4 }}
                  >
                    Masukkan nomor telepon pribadi pasien atau keluarga/kerabat
                  </Text>
                )}
              </View>
              <View style={{ marginTop: 15 }}>
            ...
            <View style={{ margin: 5 + "%" }}>
              ...
              <View style={{ marginTop: 15 }}>
                ...
                >
                  <Picker
                    selectedValue={
                      this.state.referralForm.pasien.idJenjangPendidikan
                    }
                    onValueChange={(itemValue) => {
                      let tmp = this.state.referralForm;
                  ...
                  >
                    {this.state.education.map((type) => (
                      <Picker.Item
                        label={type.namaJenjangPendidikan}
                        value={type.idJenjangPendidikan}
                        key={type.idJenjangPendidikan}
                      />
                    ))}
                  </Picker>
                </View>
                ...
                >
                  ...
                  >
                    {this.state.marriage.map((type) => (
                      <Picker.Item
                        label={type.namaStatusNikah}
                        value={type.idStatusNikah}
                        key={type.idStatusNikah}
                      />
                    ))}
            ...
            <View style={{ margin: 5 + "%" }}>
              <View>
                ...
                {!this._isError("alamat") && (
                  <Text
                    style={{ color: "#f05d5e", fontSize: 12, marginLeft: 4 }}
                  >
                    Masukkan alamat tempat tinggal pasien
                  </Text>
                )}
              </View>
              <View style={{ marginTop: 15 }}>
                ...
                >
                  ...
                  >
                    {this.state.province.map((type) => (
                      <Picker.Item
                        label={type.namaProvinsi}
                        value={type.idProvinsi}
                        key={type.idProvinsi}
                      />
                    ))}
                  </Picker>
                ...
                >
                  ...
                  >
                    {this.state.city
                      .filter(
                        (type) =>
                          type.idKota.substr(0, 2) ===
                          this.state.referralForm.pasien.idProvinsi
                      )
                      .map((type) => (
                        <Picker.Item
                          label={type.namaKota}
              ...
              <View style={{ marginTop: 15 }}>
                ...
                <TextInput
                  ...
                  style={{
                    marginLeft: 4,
                    borderBottomColor: this._isError("kodePos")
                      ? "#c4c4c4"
                      : "#f05d5e",
                    borderBottomWidth: 1,
                  }}
                ...
                {!this._isError("kodePos") && (
                  <Text
                    style={{ color: "#f05d5e", fontSize: 12, marginLeft: 4 }}
                  >
                    Masukkan kode pos dari alamat pasien
                  </Text>
                )}
              </View>
            </View>
          ...
          <View style={{ alignItems: "center", width: 100 + "%", height: 100 }}>
            <TouchableOpacity
              onPress={() => this._submitNewPatient()}
              style={{
                justifyContent: "center",
                alignItems: "center",
                width: 80 + "%",
  ...
  _submitNewPatient() {
    ...
    if (!this.state.isFound) {
      ...
      inputRequiredData = inputRequiredData.concat(
        this.state.inputRequiredData
      );
      inputRequiredDataRead = inputRequiredDataRead.concat(
        this.state.inputRequiredDataRead
      );
    }
          ...
          >
            <View style={{ marginHorizontal: 5 + "%", marginBottom: 5 + "%" }}>
              ...
              >
                <Picker
                  selectedValue={
                    this.state.referralForm.pasien.idJenisIdentitas
                  }
                  onValueChange={(itemValue) => {
                    let tmp = this.state.referralForm;
                ...
                >
                  {this.state.identityType.map((type) => (
                    <Picker.Item
                      label={type.namaJenisIdentitas}
                      value={type.idJenisIdentitas}
                      key={type.idJenisIdentitas}
                    />
                  ))}
                </Picker>
              </View>
              <View style={{ marginTop: 15 }}>
                <View>
                  ...
                  <TextInput
                    ...
                    keyboardType={"numeric"}
                    onChangeText={(text) =>
                      this.setState({ identityNumberChanged: text })
                    }
                ...
                >
                  ...
                  >
                    {this.state.insuranceType.map((type) => (
                      <Picker.Item
                        label={type.namaJenisPasien}
                        value={type.idJenisPasien}
                        key={type.idJenisPasien}
                      />
                    ))}
                  </Picker>
                </View>
              </View>
              {(this.state.isSearched || this.state.isSelected) &&
              this.state.referralForm.rujukan.statusBayar > 1 ? (
                <View style={{ marginTop: 15 }}>
                  <Text style={{ color: "#cacaca" }}>
                  ...
                  <TextInput
                    ...
                    value={
                      this.state.referralForm.rujukan.statusBayar <= 2
                        ? this.state.referralForm.pasien.noBpjs
                        : this.state.referralForm.pasien.noAsuransiLain
                    }
                    onChangeText={(text) => {
                      let tmp = this.state.referralForm;
                    ...
                    style={{
                      marginLeft: 4,
                      borderBottomColor:
                        this._isError("noBpjs") &&
                        this._isError("noAsuransiLain")
                          ? "#c4c4c4"
                          : "#f05d5e",
                      borderBottomWidth: 1,
                    }}
                  ...
                  {!(
                    ...
                    <Text
                      style={{ color: "#f05d5e", fontSize: 12, marginLeft: 4 }}
                    >
                      Masukkan nomor bpjs/asuransi pasien
                    </Text>
                  )}
                </View>
              ) : null}
              <View style={{ marginTop: 15 }}>
                <Text style={{ color: "#cacaca", textAlign: "center" }}>
                  Jika terdapat di dalam sistem, data pasien akan terisi secara
                  otomatis.
                </Text>
              </View>
              <View
                style={{ alignItems: "center", width: 100 + "%", height: 55 }}
              >
                <TouchableOpacity
                  onPress={() => this._searchPatient()}
                  style={{
                    justifyContent: "center",
                    alignItems: "center",
                    width: 80 + "%",
