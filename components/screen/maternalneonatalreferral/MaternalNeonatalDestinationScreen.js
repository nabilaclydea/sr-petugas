...
class MaternalNeonatalDestinationScreen extends Component {
        ...
        if (this.state.referralType <= 1) {
            return <View>
                ...
                <View style={{ alignItems: 'center', width: 100 + '%', height: 100 }}>
                    <TouchableOpacity
                        onPress={() =>
                            navigate('MaternalNeonatalReferralDataScreen', {
            ...
            return <View>
                <View style={{ width: 100 + '%', minHeight: 300, backgroundColor: '#ffffff' }}>
                    <View style={{ margin: 5 + '%' }}>
                        <View>
                            <Text style={{ color: '#cacaca' }}>Jenis Rujukan</Text>
                            <View style={{ width: 100 + '%', borderBottomColor: '#c4c4c4', borderBottomWidth: 1 }}>
                                <Picker>
                                    <Picker.Item label={'Emergensi'} value={1} />
                                    <Picker.Item label={'Non Emergensi'} value={2} />
                                </Picker>
                            </View>
                        </View>
                        <View style={{ marginTop: 15 }}>
                            ...
                            <View style={{ width: 100 + '%', borderBottomColor: '#c4c4c4', borderBottomWidth: 1 }}>
                                ...
                                >
                                    <Picker.Item label={'IGD'} value={1} />
                                    <Picker.Item label={'ICU'} value={2} />
                                    <Picker.Item label={'NICU'} value={3} />
                                    <Picker.Item label={'Ruang Bersalin'} value={4} />
                                </Picker>
                            </View>
...
export default MaternalNeonatalDestinationScreen;
