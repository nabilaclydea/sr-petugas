...
class MaternalNeonatalICD10Screen extends Component {
  ...
  _updateSelectedICD10(icd10) {
    ...
    if (
      current.filter(item => item.idDiagnosis === icd10.idDiagnosis).length > 0
    ) {
      ...
      <View style={styles.firstLayer}>
        ...
        <ScrollView>
          ...
          >
            <TouchableOpacity
              onPress={() => {
                navigate("MaternalNeonatalFinishScreen", {
...
export default MaternalNeonatalICD10Screen;
