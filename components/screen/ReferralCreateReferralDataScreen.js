...
class ReferralCreateReferralDataScreen extends Component {
  ...
  state = {
    ...
    // Data tambahan untuk rujukan maternal
    inputRequiredMaternal: [true, true, true, true, true, true],
    inputRequiredDataMaternal: [
      "hamilKe",
      "usiaKehamilan",
      "lingkarLenganAtas",
      "tinggiFundus",
    ...
    return (
      <TouchableOpacity
        ...
        style={{
          ...
          height: 100,
          backgroundColor:
            selectedSeverity == id ? severitiesColor[index] : "#ffffff",
      ...
      >
        ...
        >
          <Icon
            name={this.state.severitiesEmoticon[index]}
            size={20}
          ...
          <Text
            style={{
              color:
                selectedSeverity == id ? "#ffffff" : severitiesColor[index],
              fontSize: 12,
              textAlign: "center",
              marginHorizontal: 5,
            }}
          >
            {this.state.severitiesText[index]}
          </Text>
        </View>
      </TouchableOpacity>
    );
        ...
        <View>
            ...
            >
              ...
              >
                {this.state.transportations.map((transportation) => (
                  <Picker.Item
                    label={transportation.namaTransportasi}
                    value={transportation.idTransportasi}
                    key={transportation.idTransportasi}
                  />
                ))}
              </Picker>
            </View>
          ...
          <View style={{ marginTop: 15 }}>
            ...
            >
              <Picker
                selectedValue={
                  this.state.referralForm.rekamMedis.idKesadaranMata
                }
                onValueChange={(itemValue, itemIndex) => {
                  let tmp = this.state.referralForm;
          ...
          <View style={{ marginTop: 15 }}>
            ...
            >
              <Picker
                selectedValue={
                  this.state.referralForm.rekamMedis.idKesadaranVerbal
                }
                onValueChange={(itemValue, itemIndex) => {
                  let tmp = this.state.referralForm;
          ...
          <View style={{ marginTop: 15 }}>
            ...
            >
              <Picker
                selectedValue={
                  this.state.referralForm.rekamMedis.idKesadaranMotorik
                }
                onValueChange={(itemValue, itemIndex) => {
                  let tmp = this.state.referralForm;
              ...
              >
                ...
                <Picker.Item
                  label={"Menunjukkan Area yang Sakit (5+)"}
                  value={2}
                />
        ...
        <View>
          <View style={{ marginTop: 15 }}>
            ...
            <TextInput
              ...
              onChangeText={(text) => {
                let tmp = this.state.referralForm;
                tmp.rekamMedis.hamilKe = text;
                this.setState({ referralForm: tmp });
              }}
              style={{
                marginLeft: 4,
                borderBottomColor: this.state.inputRequiredMaternal[0]
                  ? "#c4c4c4"
                  : "#f05d5e",
                borderBottomWidth: 1,
              }}
          ...
          <View style={{ marginTop: 15 }}>
            ...
            <TextInput
              ...
              onChangeText={(text) => {
                let tmp = this.state.referralForm;
                tmp.rekamMedis.usiaKehamilan = text;
                this.setState({ referralForm: tmp });
              }}
              style={{
                marginLeft: 4,
                borderBottomColor: this.state.inputRequiredMaternal[1]
                  ? "#c4c4c4"
                  : "#f05d5e",
                borderBottomWidth: 1,
              }}
          ...
          <View style={{ marginTop: 15 }}>
            ...
            <TextInput
              ...
              onChangeText={(text) => {
                let tmp = this.state.referralForm;
                tmp.rekamMedis.lingkarLenganAtas = text;
                this.setState({ referralForm: tmp });
              }}
              style={{
                marginLeft: 4,
                borderBottomColor: this.state.inputRequiredMaternal[2]
                  ? "#c4c4c4"
                  : "#f05d5e",
                borderBottomWidth: 1,
              }}
          ...
          <View style={{ marginTop: 15 }}>
            ...
            <TextInput
              ...
              onChangeText={(text) => {
                let tmp = this.state.referralForm;
                tmp.rekamMedis.tinggiFundus = text;
                this.setState({ referralForm: tmp });
              }}
              style={{
                marginLeft: 4,
                borderBottomColor: this.state.inputRequiredMaternal[3]
                  ? "#c4c4c4"
                  : "#f05d5e",
                borderBottomWidth: 1,
              }}
          ...
          <View style={{ marginTop: 15 }}>
            ...
            <TextInput
              ...
              onChangeText={(text) => {
                let tmp = this.state.referralForm;
                tmp.rekamMedis.letakJanin = text;
                this.setState({ referralForm: tmp });
              }}
              style={{
                marginLeft: 4,
                borderBottomColor: this.state.inputRequiredMaternal[4]
                  ? "#c4c4c4"
                  : "#f05d5e",
                borderBottomWidth: 1,
              }}
          ...
          <View style={{ marginTop: 15 }}>
            ...
            <TextInput
              ...
              onChangeText={(text) => {
                let tmp = this.state.referralForm;
                tmp.rekamMedis.denyutJantungJanin = text;
                this.setState({ referralForm: tmp });
              }}
              style={{
                marginLeft: 4,
                borderBottomColor: this.state.inputRequiredMaternal[5]
                  ? "#c4c4c4"
                  : "#f05d5e",
                borderBottomWidth: 1,
              }}
  ...
  // Tampilan Rujuk Neonatal
  _setNeonatalScreen() {
    if (this.state.referralType == 4) {
      return (
        <View>
          <View style={{ marginTop: 15 }}>
            <Text style={{ color: "#cacaca" }}>
            ...
            <TextInput
              ...
              onChangeText={(text) => {
                let tmp = this.state.referralForm;
                tmp.rekamMedis.anakKe = text;
                this.setState({ referralForm: tmp });
              }}
              style={{
                marginLeft: 4,
                borderBottomColor: this.state.inputRequiredNeonatal[0]
                  ? "#c4c4c4"
                  : "#f05d5e",
                borderBottomWidth: 1,
              }}
          ...
          <View style={{ marginTop: 15 }}>
            ...
            <TextInput
              ...
              onChangeText={(text) => {
                let tmp = this.state.referralForm;
                tmp.rekamMedis.umurAnak = text;
                this.setState({ referralForm: tmp });
              }}
              style={{
                marginLeft: 4,
                borderBottomColor: this.state.inputRequiredNeonatal[1]
                  ? "#c4c4c4"
                  : "#f05d5e",
                borderBottomWidth: 1,
              }}
          ...
          <View style={{ marginTop: 15 }}>
            ...
            <TextInput
              ...
              onChangeText={(text) => {
                let tmp = this.state.referralForm;
                tmp.rekamMedis.lingkarKepala = text;
                this.setState({ referralForm: tmp });
              }}
              style={{
                marginLeft: 4,
                borderBottomColor: this.state.inputRequiredNeonatal[2]
                  ? "#c4c4c4"
                  : "#f05d5e",
                borderBottomWidth: 1,
              }}
          ...
          <View style={{ marginTop: 15 }}>
            ...
            <TextInput
              ...
              onChangeText={(text) => {
                let tmp = this.state.referralForm;
                tmp.rekamMedis.imunisasi = text;
                this.setState({ referralForm: tmp });
              }}
              style={{
                marginLeft: 4,
                borderBottomColor: this.state.inputRequiredNeonatal[3]
                  ? "#c4c4c4"
                  : "#f05d5e",
                borderBottomWidth: 1,
              }}
  ...
  _submit() {
    ...
    let inputRequiredDataEmergencyRead = this.state
      .inputRequiredDataEmergencyRead;

    let inputRequiredMaternal = this.state.inputRequiredMaternal;
    let inputRequiredDataMaternal = this.state.inputRequiredDataMaternal;
    let inputRequiredDataMaternalRead = this.state
      .inputRequiredDataMaternalRead;

    let inputRequiredNeonatal = this.state.inputRequiredNeonatal;
    let inputRequiredDataNeonatal = this.state.inputRequiredDataNeonatal;
    let inputRequiredDataNeonatalRead = this.state
      .inputRequiredDataNeonatalRead;
    ...
    // Cek input yang dibutuhkan untuk rujuk maternal
    if (this.state.referralType == 3) {
      inputRequiredMaternal.map(function (input, index) {
        let tmp = true;
        if (!tmpRekamMedis[inputRequiredDataMaternal[index]]) {
          tmp = false;
          result = false;
          errorCount = errorCount + 1;

          if (errorCount <= 5) {
            errorMaternal.push(inputRequiredDataMaternalRead[index]);
          }
        }

        inputRequiredMaternal[index] = tmp;
      });
    }

    // Cek input yang dibutuhkan untuk rujuk neonatal
    if (this.state.referralType == 4) {
      inputRequiredNeonatal.map(function (input, index) {
        let tmp = true;
        if (!tmpRekamMedis[inputRequiredDataNeonatal[index]]) {
          tmp = false;
          result = false;
          errorCount = errorCount + 1;

          if (errorCount <= 5) {
            errorNeonatal.push(inputRequiredDataNeonatalRead[index]);
          }
        }

        inputRequiredNeonatal[index] = tmp;
      });
    }
    ...
    this.setState({
      ...
      inputRequiredMaternal: inputRequiredMaternal,
      inputRequiredNeonatal: inputRequiredNeonatal,
    });
        ...
        <ScrollView>
          ...
          >
            <View style={{ margin: 5 + "%" }}>
              <View style={{ marginTop: 15 }}>
                <Text style={{ color: "#cacaca" }}>
                  Dokumen Hasil Pemeriksaan Darah (dalam format PDF)
                </Text>
                <View
                  style={{
                    flexDirection: "row",
              ...
              <View style={{ marginTop: 15 }}>
                <Text style={{ color: "#cacaca" }}>
                  Dokumen Riwayat Sakit Lainnya (dalam format PDF)
                </Text>
                <View
                  style={{
                    flexDirection: "row",
