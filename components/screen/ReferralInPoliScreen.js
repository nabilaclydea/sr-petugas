...
import {View, ScrollView, TouchableOpacity, TextInput, Image, Text, StyleSheet, StatusBar} from 'react-native';
import Icon from "react-native-vector-icons/MaterialCommunityIcons";
import Spinner from 'react-native-loading-spinner-overlay';
import AsyncStorage from '@react-native-community/async-storage';

class ReferralInPoliScreen extends Component {
                ...
                >
                    ...
                    <View
                        ...
                        <View style={{
                            ...
                            <Text style={{fontSize: 12, color: '#c4c4c4'}}>{referral.poli.namaJenisPoli}</Text>
                        </View>
                    </View>
                </TouchableOpacity>
...
export default ReferralInPoliScreen;